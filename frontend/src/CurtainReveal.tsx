          ...
          <div className="result-container text-center opacity-0" style={{
            ...
            {result.status === 'diterima' && whatsappGroupLink ? (
              <a
                ...
                className="mt-6 px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg transition-all font-['Cinzel_Decorative'] tracking-wider shadow-lg flex items-center justify-center gap-2 mx-auto max-w-xs"
              >
